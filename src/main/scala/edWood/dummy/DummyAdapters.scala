...
class DummyWriter1() extends WriterAdapter with DefaultLogs {
...
class DummyWriter2() extends WriterAdapter with DefaultLogs {
  override def init(args:Array[String]) = {
...
class DummyReader1() extends ReaderAdapter with DefaultLogs {
...
class DummyReader2() extends ReaderAdapter with DefaultLogs {
...
class DummyWriter3() extends WriterAdapter with DefaultLogs {
  override def init(args:Array[String]) = {
    info("nothing to init")
  }
...
class DummyReader3() extends ReaderAdapter with DefaultLogs {
